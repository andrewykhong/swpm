...
namespace MathExtra {
  ...
  // n vector operation
  inline void normn(double *v, const int n);
  inline double dotn(const double *v1, const double *v2, const int n);
...
/* ----------------------------------------------------------------------
   normalize a vector of arbitrary size in place
------------------------------------------------------------------------- */

void MathExtra::normn(double *v, const int n)
{
  long double scale = 0.0;
  for(int i = 0; i < n; i++) scale += v[i]*v[i];
  if(scale > 0.0) {
...
/* ----------------------------------------------------------------------
   dot product of 2 vectors of arbitary size
------------------------------------------------------------------------- */

double MathExtra::dotn(const double *v1, const double *v2, const int n)
{
  double dprod = 0;
  for(int i = 0; i < n; i++) dprod += v1[i]*v2[i];
  return dprod;
}
#endif
