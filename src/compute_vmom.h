...
ComputeStyle(vmom/grid/sw,ComputeVmomGridSW)

#else

#ifndef SPARTA_COMPUTE_VMOM_GRID_SW_H
#define SPARTA_COMPUTE_VMOM_GRID_SW_H

#include "compute.h"

namespace SPARTA_NS {

class ComputeVmomGridSW : public Compute {
 public:
  ComputeVmomGridSW(class SPARTA *, int, char **);
  ~ComputeVmomGridSW();
  void init();
